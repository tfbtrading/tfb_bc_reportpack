...
Report 53006 "TFB Item Trace"
{
    ...
    dataset
    {
        dataitem(Item; Item)
        {
            ...
            {
                DataItemTableView = sorting("Posting Date") where("Entry Type" = CONST(0), "Entry Type" = CONST(4), "Entry Type" = CONST(2), Positive = CONST(true));
            ...
            {
                DataItemTableView = sorting("Posting Date") where("Entry Type" = CONST(1), "Entry Type" = CONST(3), "Entry Type" = CONST(4), Positive = CONST(false));
                DataItemLink = "Item No." = FIELD("No.");
