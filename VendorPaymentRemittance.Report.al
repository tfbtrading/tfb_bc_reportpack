...
Report 53007 "TFB Vendor Payment Remittance"
{
	...
	WordLayout = './Layouts/TFBVendorPaymentRemittance.docx'; DefaultLayout = Word;

	dataset
	{
		dataitem(PaymentLedgerEntries;"Vendor Ledger Entry")
		{
			CalcFields = "Remaining Amount", "Remaining Amt. (LCY)",Amount;
	...
	begin
		...
		case (dataItemId) of
			'AppliedLedgerEntries':
				begin
					currLanguage := GlobalLanguage; GlobalLanguage := 1033; jsonObject.Add('DataItem$AppliedLedgerEntries$CurrentKey$Text',AppliedLedgerEntries.CurrentKey); GlobalLanguage := currLanguage;
				end;
		end;
